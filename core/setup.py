...
import core.agents  # noqa F401 (we import this to get the agents registered)
...
from extensions.integrations.provider import ProviderToken, ProviderType
from core.llm.llm import LLM
from core.storage.memory import Memory
from core.runtime import get_runtime_cls
from core.runtime.base import Runtime
from extensions.security import SecurityAnalyzer, options
from core.storage import get_file_store
from core.storage.data_models.user_secrets import UserSecrets
from core.utils.async_utils import GENERAL_TIMEOUT, call_async_from_sync
...
def initialize_repository_for_runtime(
    ...
    secret_store = (
        UserSecrets(provider_tokens=provider_tokens) if provider_tokens else None  # type: ignore
    )
