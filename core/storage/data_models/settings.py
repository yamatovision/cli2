...
from core.config.utils import load_openhands_config
...
class Settings(BaseModel):
    ...
    def convert_provider_tokens(cls, data: dict | object) -> dict | object:
        ...
        if isinstance(tokens, dict):
            converted_store = UserSecrets(provider_tokens=tokens)  # type: ignore
        ...
        if isinstance(custom_secrets, dict):
            converted_store = UserSecrets(custom_secrets=custom_secrets)  # type: ignore
            secret_store = secret_store.model_copy(
