...
from core.config.condenser_config import CondenserConfig, NoOpCondenserConfig
...
class AgentConfig(BaseModel):
    ...
    system_prompt_filename: str = Field(default='orchestrator')
    """Agent name for Portal API prompt management. Defaults to 'orchestrator'."""
