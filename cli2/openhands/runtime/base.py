...
# Microagent functionality removed
...
"""
    ...
    def _load_microagents_from_directory(
        ...
        """Load microagents from a directory. (DEPRECATED - microagent functionality removed)."""
        return []
    ...
    def get_microagents_from_org_or_user(
        ...
        """Load microagents from the organization or user level .openhands repository. (DEPRECATED - microagent functionality removed)."""
        return []

    def get_microagents_from_selected_repo(
        self, selected_repository: str | None
    ) -> list:
        """Load microagents from the selected repository. (DEPRECATED - microagent functionality removed)."""
        return []
