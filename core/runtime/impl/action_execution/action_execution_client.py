...
from core.events.action.files import FileEditSource
...
class ActionExecutionClient(Runtime):
    ...
    async def call_tool_mcp(self, action: MCPAction) -> Observation:
        ...
        from core.mcp.utils import call_tool_mcp as call_tool_mcp_handler
        from core.mcp.utils import create_mcp_clients
