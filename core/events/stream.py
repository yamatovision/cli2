...
from core.events.serialization.event import event_from_dict, event_to_dict
from core.io import json
    ...
    def _make_error_handler(
        ...
        def _handle_callback_error(fut: Any) -> None:
            try:
                ...
                logger.error(
                    f'Error in event callback {callback_id} for subscriber {subscriber_id}: {e!s}',
                )
